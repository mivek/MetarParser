...
public abstract class AbstractWeatherContainer {
  ...
  public String toString() {
    ...
    builder
        .append(
            Messages.getInstance().getString("ToString.vertical.visibility"), verticalVisibility)
        .append(Messages.getInstance().getString("ToString.clouds"), clouds.toString())
        .append(
            Messages.getInstance().getString("ToString.weather.conditions"),
            weatherConditions.toString());
    if (windShear != null) {
      builder.appendToString(windShear.toString());
    }
    builder
        .append(Messages.getInstance().getString("ToString.cavok"), cavok)
