...
public class HourlyMaximumTemperatureCommandTest {
  ...
  public void testExecuteBelowZero() {
    ...
    MatcherAssert.assertThat(
        sb.toString(), CoreMatchers.containsString("6-hourly maximum temperature of -2.1°C"));
  }
  ...
  public void testExecuteAboveZero() {
    ...
    MatcherAssert.assertThat(
        sb.toString(), CoreMatchers.containsString("6-hourly maximum temperature of 14.2°C"));
  }
