...
public class TAFParserTest extends AbstractParserTest<TAF> {
  ...
  void testParseValidWithInvalidLineBreaks() throws ParseException {
    ...
    assertThat(
        res.getTempos().get(0).getWeatherConditions().get(0).getIntensity(), is(nullValue()));
    assertThat(
        res.getTempos().get(0).getWeatherConditions().get(0).getDescriptive(), is(nullValue()));
    assertThat(res.getTempos().get(0).getWeatherConditions().get(0).getPhenomenons(), hasSize(1));
    assertThat(
        res.getTempos().get(0).getWeatherConditions().get(0).getPhenomenons().get(0),
        is(Phenomenon.MIST));
    ...
    assertThat(
        res.getTempos().get(1).getWeatherConditions().get(0).getIntensity(), is(nullValue()));
    assertThat(
        res.getTempos().get(1).getWeatherConditions().get(0).getDescriptive(),
        is(Descriptive.PATCHES));
    assertThat(res.getTempos().get(1).getWeatherConditions().get(0).getPhenomenons(), hasSize(1));
    assertThat(
        res.getTempos().get(1).getWeatherConditions().get(0).getPhenomenons().get(0),
        is(Phenomenon.FOG));
    ...
    assertThat(
        res.getTempos().get(2).getWeatherConditions().get(0).getIntensity(), is(Intensity.LIGHT));
    assertThat(
        res.getTempos().get(2).getWeatherConditions().get(0).getDescriptive(),
        is(Descriptive.SHOWERS));
    assertThat(res.getTempos().get(2).getWeatherConditions().get(0).getPhenomenons(), hasSize(1));
    assertThat(
        res.getTempos().get(2).getWeatherConditions().get(0).getPhenomenons().get(0),
        is(Phenomenon.RAIN));
  ...
  void testParseValidWithoutLineBreaks() throws ParseException {
    String taf =
        "TAF LSZH 292025Z 2921/3103 VRB03KT 9999 FEW020 BKN080 TX20/3014Z TN06/3003Z "
  ...
  void testParseValidWithoutLineBreaksAndEndingTemperature() throws ParseException {
    String taf =
        "TAF KLSV 120700Z 1207/1313 VRB06KT 9999 SCT250 QNH2992INS BECMG 1217/1218 10010G15KT 9999"
            + " SCT250 QNH2980INS BECMG 1303/1304 VRB06KT 9999 FEW250 QNH2979INS TX42/1223Z"
            + " TN24/1213Z";
  ...
  void testParseWithFM() throws ParseException {
    ...
    assertEquals(
        Messages.getInstance().getString("Converter.VRB"),
        res.getTempos().get(0).getWind().getDirection());
  ...
  void testParseWithRMKInTempo() throws ParseException {
    ...
    String rmk =
        Messages.getInstance().getString(REMARK_FCST)
            + " "
            + Messages.getInstance().getString("Remark.BASED")
            + " "
            + Messages.getInstance().getString("Remark.ON")
            + " AUTO OBS. "
            + Messages.getInstance().getString(REMARK_NXT)
            + " "
            + Messages.getInstance().getString(REMARK_FCST)
            + " BY 301400Z";
  ...
  void testParseWithRMK() throws ParseException {
    ...
    String message =
        "TAF CZBF 300939Z 3010/3022 VRB03KT 6SM -SN OVC015 RMK FCST BASED ON AUTO OBS. NXT FCST BY"
            + " 301400Z\n"
            + "TEMPO 3010/3012 11/2SM -SN OVC009 FM301200 10008KT 2SM -SN OVC010 \n"
    ...
    assertThat(
        description,
        containsString(Messages.getInstance().getString("ToString.start.day.month") + "=30"));
    assertThat(
        description,
        containsString(Messages.getInstance().getString("ToString.start.hour.day") + "=10"));
    assertThat(
        description,
        containsString(Messages.getInstance().getString("ToString.end.day.month") + "=30"));
    assertThat(
        description,
        containsString(Messages.getInstance().getString("ToString.end.hour.day") + "=12"));
  }
  ...
  void testParseWithInter() throws ParseException {
    ...
    assertThat(
        result.getInters().get(0).getWeatherConditions().get(0).getPhenomenons(), hasSize(1));
    assertThat(
        result.getInters().get(0).getWeatherConditions().get(0).getPhenomenons().get(0),
        is(Phenomenon.RAIN));
    assertThat(
        result.getInters().get(0).getWeatherConditions().get(0).getDescriptive(),
        is(Descriptive.SHOWERS));
