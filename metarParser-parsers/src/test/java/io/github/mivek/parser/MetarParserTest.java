...
public class MetarParserTest extends AbstractParserTest<Metar> {
  ...
  public void testParse() {
    String metarString =
        "LFPG 170830Z 00000KT 0350 R27L/0375N R09R/0175N R26R/0500D R08L/0400N R26L/0275D"
            + " R08R/0250N R27R/0300N R09L/0200N FG SCT000 M01/M01 Q1026 NOSIG";
    ...
    assertEquals(
        Messages.getInstance().getString("Converter.NSC"), m.getRunways().get(0).getTrend());
  }

  @Test
  public void testParseNullAirport() {
    String metarString =
        "AAAA 170830Z 00000KT 0350 R27L/0375N R09R/0175N R26R/0500D R08L/0400N R26L/0275D"
            + " R08R/0250N R27R/0300N R09L/0200N FG SCT000 M01/M01 Q1026 NOSIG";
    Metar m = parser.parse(metarString);
  ...
  public void testParseWithTempo() {
    String metarString =
        "LFBG 081130Z AUTO 23012KT 9999 SCT022 BKN072 BKN090 22/16 Q1011 TEMPO 26015G25KT 3000 TSRA"
            + " SCT025CB BKN050";
  ...
  public void testParseWithTempoAndFMAndTL() {
    ...
    assertThat(
        toString,
        containsString(Messages.getInstance().getString("WeatherChangeType.FM") + " 17:00"));
    assertThat(
        toString, containsString(Messages.getInstance().getString("TimeIndicator.TL") + " 18:30"));
  ...
  public void testParseWithMinVisibility() {
    ...
    assertThat(
        des, containsString(Messages.getInstance().getString("ToString.report.time") + "=14:30"));
    assertThat(
        des,
        containsString(
            Messages.getInstance().getString("ToString.wind.direction.degrees") + "=240"));
  }
  ...
  public void testParseWithVerticalVisibility() {
    ...
    assertThat(
        m.toString(),
        containsString(Messages.getInstance().getString("ToString.visibility.main") + "=350m"));
  }
  ...
  public void testParseWithRMK() {
    ...
    String code =
        "CYWG 172000Z 30015G25KT 1 3/4SM R36/4000FT/D -SN BLSN BKN008 OVC040 M05/M08 Q1001 RMK"
            + " SF5NS3 SLP134";
    // WHEN parsing the metar
    Metar m = parser.parse(code);
    ...
    assertThat(
        m.getRemark(),
        containsString(
            "SF5NS3 " + Messages.getInstance().getString("Remark.Sea.Level.Pressure", "1013.4")));
  }
  ...
  public void testParseWithRemarks() {
    String code =
        "KCOS 261454Z 34012G18KT 10SM BKN060 BKN100 15/10 A3020 RMK AO2 RAE45 SLP171 P0000 60002"
            + " T01500100 51009 $";
    ...
    assertThat(
        m.getRemark(), containsString("automated station with a precipitation discriminator"));
    ...
    assertThat(
        m.getRemark(), containsString("0/100 of an inch of precipitation fell in the last hour"));
    assertThat(
        m.getRemark(), containsString("0/100 of an inch of precipitation fell in the last hour"));
    assertThat(
        m.getRemark(), containsString("0.02 inches of precipitation fell in the last 6 hours"));
    assertThat(m.getRemark(), containsString("hourly temperature of 15°C and dew point of 10°C"));
    assertThat(
        m.getRemark(),
        containsString(
            "Increase, then steady, or increase then Increase more slowly of 0.9 hectopascals in"
                + " the past 3 hours"));
  }
