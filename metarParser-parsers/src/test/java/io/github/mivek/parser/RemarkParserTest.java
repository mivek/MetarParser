...
public class RemarkParserTest {
  ...
  public void testParsePrevailingVisibility() {
    ...
    String expectedRmk =
        Messages.getInstance().getString("Remark.Variable.Prevailing.Visibility", "1/2", "2");
    assertThat(remark, containsString(expectedRmk));
  }
  ...
  public void testParseSectorVisibility() {
    ...
    String expectedRmk =
        Messages.getInstance()
            .getString(
                "Remark.Sector.Visibility",
                Messages.getInstance().getString(CONVERTER_NE),
                "2 1/2");
    assertThat(remark, containsString(expectedRmk));
  }
  ...
  public void testParseSecondLocationVisibility() {
    ...
    String expectedRmk =
        Messages.getInstance().getString("Remark.Second.Location.Visibility", "2 1/2", "RWY11");
    assertThat(remark, containsString(expectedRmk));
  }
  ...
  public void testParseTornadicActivityWithTornado() {
    ...
    String expectedRmk =
        Messages.getInstance()
            .getString(
                "Remark.Tornadic.Activity.Beginning",
                Messages.getInstance().getString("Remark.TORNADO"),
                "",
                "13",
                "6",
                Messages.getInstance().getString(CONVERTER_NE));
  ...
  public void testParseTornadicActivityWithFunnelCloud() {
    ...
    String expectedRmk =
        Messages.getInstance()
            .getString(
                "Remark.Tornadic.Activity.BegEnd",
                Messages.getInstance().getString("Remark.FUNNELCLOUD"),
                "15",
                "13",
                "16",
                "30",
  ...
  public void testParseTornadicActivityWithWaterSproutAndEndingTimeOnlyMinutes() {
    ...
    String expectedRmk =
        Messages.getInstance()
            .getString(
                "Remark.Tornadic.Activity.Ending",
                Messages.getInstance().getString("Remark.WATERSPOUT"),
                "",
                "16",
                "12",
                Messages.getInstance().getString(CONVERTER_NE));
  ...
  public void testParseBeginningEndPrecipitation() {
    ...
    String expectedRmk1 =
        Messages.getInstance()
            .getString(
                REMARK_PRECIPITATION_BEG_END,
                "",
                Messages.getInstance().getString("Phenomenon.RA"),
                "",
                "05",
                "",
                "30");
    String expectedRmk2 =
        Messages.getInstance()
            .getString(
                REMARK_PRECIPITATION_BEG_END,
                "",
                Messages.getInstance().getString("Phenomenon.SN"),
                "15",
                "20",
                "16",
                "55");
  ...
  public void testParseBeginningEndPrecipitationWithDescriptive() {
    ...
    String expectedRmk1 =
        Messages.getInstance()
            .getString(
                REMARK_PRECIPITATION_BEG_END,
                Messages.getInstance().getString("Descriptive.SH"),
                Messages.getInstance().getString("Phenomenon.RA"),
                "",
                "05",
                "",
    ...
    String expectedRmk1 =
        Messages.getInstance()
            .getString(
                REMARK_PRECIPITATION_BEG_END,
                "",
                Messages.getInstance().getString("Phenomenon.TS"),
                "01",
                "59",
                "",
                "30");
  ...
  public void testParseThunderStormLocation() {
    ...
    String expected =
        Messages.getInstance()
            .getString(
                "Remark.Thunderstorm.Location", Messages.getInstance().getString("Converter.SE"));
  ...
  public void testParseThunderStormLocationWithMoving() {
    ...
    String expected =
        Messages.getInstance()
            .getString(
                "Remark.Thunderstorm.Location.Moving",
                Messages.getInstance().getString("Converter.SE"),
                Messages.getInstance().getString(CONVERTER_NE));
    assertThat(remark, containsString(expected));
  }
  ...
  public void testParseSnowPellets() {
    ...
    String expected =
        Messages.getInstance()
            .getString("Remark.Snow.Pellets", Messages.getInstance().getString("Remark.MOD"));
    assertThat(remark, containsString(expected));
  }
  ...
  public void testParseVirgaWithDirection() {
    ...
    String expected =
        Messages.getInstance()
            .getString("Remark.Virga.Direction", Messages.getInstance().getString("Converter.SW"));
    assertThat(remark, containsString(expected));
  }
  ...
  public void testParseObscurations() {
    ...
    String expected =
        Messages.getInstance()
            .getString(
                "Remark.Obscuration",
                Messages.getInstance().getString(CLOUD_QUANTITY_BKN),
                2000,
                Messages.getInstance().getString("Phenomenon.FU"));
    assertThat(remark, containsString(expected));
  }
  ...
  public void testParseVariableSkyConditionWithoutLayer() {
    ...
    String expected =
        Messages.getInstance()
            .getString(
                "Remark.Variable.Sky.Condition",
                Messages.getInstance().getString(CLOUD_QUANTITY_BKN),
                Messages.getInstance().getString("CloudQuantity.OVC"));
    assertThat(remark, containsString(expected));
  }
  ...
  public void testParseVariableSkyCondition() {
    ...
    String expected =
        Messages.getInstance()
            .getString(
                "Remark.Variable.Sky.Condition.Height",
                1400,
                Messages.getInstance().getString(CLOUD_QUANTITY_BKN),
                Messages.getInstance().getString("CloudQuantity.OVC"));
    assertThat(remark, containsString(expected));
  ...
  public void testParseCeilingSecondLocation() {
    ...
    String remark = parser.parse(code);
    String expected =
        Messages.getInstance().getString("Remark.Ceiling.Second.Location", 200, "RWY11");
    assertThat(remark, containsString(expected));
  }
  ...
  public void testParseWithRmkSlp() {
    ...
    assertThat(
        remark,
        containsString(Messages.getInstance().getString(REMARK_SEA_LEVEL_PRESSURE, "1009.1")));
  }
