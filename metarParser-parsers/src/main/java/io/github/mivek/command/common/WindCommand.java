...
public final class WindCommand implements BaseWindCommand {
  ...
  private static final Pattern WIND_REGEX =
      Pattern.compile("^(VRB|\\d{3})(\\d{2})G?(\\d{2})?(KT|MPS|KM/H)?");

  /** Package private constructor. */
  WindCommand() {}

  /**
   * This method parses the wind part of the metar code. It parses the generic part.
   *
