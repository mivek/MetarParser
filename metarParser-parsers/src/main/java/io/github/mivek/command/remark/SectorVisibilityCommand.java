...
public final class SectorVisibilityCommand implements Command {
  /** Sector visibility. */
  private static final Pattern SECTOR_VISIBILITY =
      Pattern.compile("^VIS ([A-Z]{1,2}) ((\\d)*( )?(\\d?/?\\d))");
    ...
    stringBuilder
        .append(
            messages.getString(
                ...
                messages.getString("Converter." + sectorVisibilityParts[1]),
                sectorVisibilityParts[2]))
        .append(" ");
