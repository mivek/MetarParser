...
public final class RunwayCommand implements Command {
  ...
  private static final Pattern RUNWAY_MAX_RANGE_REGEX =
      Pattern.compile("^R(\\d{2}\\w?)/(\\d{4})V(\\d{3,4})([UDN])?(FT)?");
  /** Pattern regex for runway visibility. */
  private static final Pattern RUNWAY_REGEX =
      Pattern.compile("^R(\\d{2}\\w?)/([MP])?(\\d{4})([UDN])?(FT)?$");
  /** Pattern regex for runway deposit. */
  private static final Pattern RUNWAY_DEPOSIT_REGEX =
      Pattern.compile("^R(\\d{2}\\w?)/([/\\d])([/\\d])(//|\\d{2})(//|\\d{2})$");
  /** Immutable map of type of deposit. */
  private static final Map<String, DepositType> DEPOSIT_TYPE_MAP =
      Stream.of(
  ...
  private static final Map<String, DepositCoverage> DEPOSIT_COVERAGE_MAP =
      Stream.of(
  ...
  private static final Map<String, DepositThickness> DEPOSIT_THICKNESS_MAP =
      Stream.of(
  ...
  private static final Map<String, DepositBrakingCapacity> DEPOSIT_BRAKING_CAPACITY_MAP =
      Stream.of(
