...
public final class ThunderStormLocationMovingCommand implements Command {
  ...
  private static final Pattern THUNDERSTORM_LOCATION_MOVING =
      Pattern.compile("^TS ([A-Z]{2}) MOV ([A-Z]{2})");
    ...
    stringBuilder
        .append(
            messages.getString(
                ...
                messages.getString("Converter." + thunderStormParts[1]),
                messages.getString("Converter." + thunderStormParts[2])))
        .append(" ");
