...
public final class WaterEquivalentSnowCommand implements Command {
  ...
  private static final Pattern WATER_EQUIVALENT_SNOW_GROUND_PATTERN =
      Pattern.compile("^933(\\d{3})\\b");
  ...
  public String execute(final String remark, final StringBuilder stringBuilder) {
    ...
    stringBuilder
        .append(
            messages.getString(
                "Remark.Water.Equivalent.Snow.Ground",
                Float.parseFloat(precipitationAmount[1]) / 10))
        .append(" ");
