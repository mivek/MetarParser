...
public final class HourlyPrecipitationAmountCommand implements Command {
  ...
  private static final Pattern HOURLY_PRECIPITATION_AMOUNT_PATTERN =
      Pattern.compile("^P(\\d{4})\\b");
  ...
  public String execute(final String remark, final StringBuilder stringBuilder) {
    ...
    stringBuilder
        .append(
            messages.getString(
                "Remark.Precipitation.Amount.Hourly", Integer.parseInt(precipitationAmount[1])))
        .append(" ");
