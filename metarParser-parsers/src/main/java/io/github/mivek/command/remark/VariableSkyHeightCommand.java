...
public final class VariableSkyHeightCommand implements Command {
  ...
  private static final Pattern VARIABLE_SKY_HEIGHT =
      Pattern.compile("^([A-Z]{3})(\\d{3}) V ([A-Z]{3})\\b");
  ...
  public String execute(final String remark, final StringBuilder stringBuilder) {
    ...
    stringBuilder
        .append(messages.getString("Remark.Variable.Sky.Condition.Height", height, layer1, layer2))
        .append(" ");
