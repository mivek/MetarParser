...
public final class Converter {
  ...
  public static String degreesToDirection(final String degreesStr) {
    ...
    return Messages.getInstance()
        .getString("Converter." + DIRECTIONS[(int) ((degrees + 11.5) / 22.5) % DIRECTIONS.length]);
  }
  ...
  /**
   * Converts a string representing a time to a LocalTime. Eg: "0830" returns a LocalTime of 08:30.
   *
